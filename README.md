...
### Deployment
Deploys auf unserer [unstable environment](appoint-er-unstable.herokuapp.com) laufen automatisch bei jedem GitHub push.
Der deploy auf die [production environment](appoint-er.herokuapp.com) müssen manuell aus dem Heroku Dashboard ausgelöst werden.
